...
./${APP}: obj/main.o obj/Position.o obj/Piece.o obj/GameTree.o obj/Player.o obj/Board.o 
	g++ -o ./${APP} obj/main.o obj/Position.o obj/Piece.o obj/GameTree.o obj/Player.o obj/Board.o 

obj/main.o: src/main.cpp inc/Position.h inc/Piece.h inc/Player.h inc/GameTree.h inc/Board.h 
